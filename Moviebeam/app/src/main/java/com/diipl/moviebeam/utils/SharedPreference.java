...
//    }
    ...
    public void setAdultPassCode(String passCode) {
        putString("AdultPassCode", passCode);
    }

    public String getAdultPassCode() {
        return preferences.getString("AdultPassCode", "____");
    }

    public Boolean isAdultPassCodeEmpty() {
        String passCode = getAdultPassCode();
        return passCode.equals("____");
    }

    public void setAdultContentEnabled(boolean enabled) {
        putBoolean("AdultContentDisabled", enabled);
    }

    public boolean isAdultContentEnabled() {
        return getBoolean("AdultContentDisabled");
    }

    public void setMainAdultMCW(boolean disabled) {
        putBoolean("MainAdultMCW", disabled);
    }

    public boolean isMainAdultMCW() {
        return getBoolean("MainAdultMCW");
    }

    public void setBtnAdultMCW(boolean disabled) {
        putBoolean("BtnAdultMCW", disabled);
    }

    public boolean isBtnAdultMCW() {
        return getBoolean("BtnAdultMCW");
    }

    public void setAdultMCD(boolean disabled) {
        putBoolean("AdultMCD", disabled);
    }

    public boolean isAdultMCD() {
        return getBoolean("AdultMCD");
    }

    public void setAdultLocked(boolean locked) {
        putBoolean("AdultLocked", locked);
    }
